...
The shared context for the project. Parallel agents read the relevant doc(s) + the
crate's `CONTRACT.md` + `divebridge-core` — not the whole codebase.

- [decisions-log.md](decisions-log.md) — locked decisions & ADRs (from grilling)
